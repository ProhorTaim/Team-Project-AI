...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function analyzeNewIdea(userIdea) {
        var systemForNew = 'Ты — эксперт по проектной деятельности университета.\n\n' +
            ...
            'ПРАВИЛА:\n' +
            '- Если идея бессмысленная или оскорбление — ответь: «Идея не сформулирована. Попробуйте описать проблему, которую решает ваш проект.»\n' +
            '- Если идея интересная — скажи: «Такой проект ещё не реализован» и предложи конкретные шаги.\n' +
            ...
            '<p>1-2 предложения.</p>\n\n' +
            '<h3>Слепые зоны</h3>\n' +
            '<ul><li>что может пойти не так</li></ul>\n\n' +
            '<h3>Следующий шаг</h3>\n' +
            '<p>Одно конкретное действие.</p>';
